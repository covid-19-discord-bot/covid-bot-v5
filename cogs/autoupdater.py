...
class AutoUpdaterCog(Cog):
    ...
    async def _custom(self, ctx: MyContext, delay: ShortTime, *, custom: str):
        ...
        try:
            ...
            msg = await ctx.reply(_("Try sending your command again. If it errors out again, wait a few moments."))
    ...
    async def run_updates_in_channels(self, channels: List[list]):
        for channel_data in channels:
            ...
            try:
                ...
                elif updater.type == AutoupdateTypes.custom:
                    msg_to_send = await autoupdater.custom(ctx, country)
